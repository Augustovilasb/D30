          ...
          <div className="nav-links">
            {user ? (
              <React.Fragment>
                ...
                <button className={'nav-link' + (page === 'palestras' ? ' active' : '')} data-cursor="hover" onClick={() => onNavigate('palestras')}>Talks</button>
                <button className={'nav-link' + (page === 'tracker'   ? ' active' : '')} data-cursor="hover" onClick={() => (onNavigateTo || onNavigate)('tracker')}>Progresso</button>
                <button className={'nav-link' + (page === 'livros'    ? ' active' : '')} data-cursor="hover" onClick={() => (onNavigateTo || onNavigate)('livros')}>Livros</button>
