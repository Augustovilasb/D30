        ...
        <div className="pub-hero">
          ...
          <div className="pub-hero-body">
            ...
            <div className="pub-hero-actions-row pub-share-popup-wrap">
              <div className="pub-actions-primary">
              ...
              {(user.github_url || user.linkedin_url || user.instagram_url || user.twitter_url || user.website_url) && (
                <div className="pub-actions-socials">
