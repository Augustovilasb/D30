  ...
  return (
    <div className="discord-modal-overlay">
      <div className="discord-modal" onClick={e => e.stopPropagation()}>
        ...
        <a className="discord-join-btn" href="https://discord.gg/eUFsMDuUm" target="_blank" rel="noopener noreferrer" data-cursor="hover">
        ...
        <label className="discord-check-label" data-cursor="hover">
          <input type="checkbox" checked={checked} onChange={e => setChecked(e.target.checked)} />
          <span className="discord-check-box">{checked && '✓'}</span>
          Já entrei no Discord
        </label>
